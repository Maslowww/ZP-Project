...
define config.name = _("Fallen Angel")
...
define config.version = "2.28"


## Текст, помещённый в экран "Об игре". Поместите текст между тройными скобками.
## Для отделения абзацев оставляйте между ними пустую строку.

define gui.about = _p("""Игра, сколоченная на скорую руку тремя(1) балбесами и Васей
""")
...
define config.main_menu_music = "music/soothsayer.flac"
...
define config.save_directory = "ZP-1619116537"
...
define config.window_icon = "images/logo.jpg"
